...
export function fromContext(context) {
    ...
    var toneFromContext = __assign(__assign({}, classesWithContext), { now: context.now.bind(context), immediate: context.immediate.bind(context), Transport: context.transport, Destination: context.destination, Listener: context.listener, Draw: context.draw, context: context, 
        // the type functions
