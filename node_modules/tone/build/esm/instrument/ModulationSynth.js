...
var ModulationSynth = /** @class */ (function (_super) {
    ...
    ModulationSynth.getDefaults = function () {
        return Object.assign(Monophonic.getDefaults(), {
            harmonicity: 3,
            oscillator: Object.assign(omitFromObject(OmniOscillator.getDefaults(), __spread(Object.keys(Source.getDefaults()), [
                "frequency",
                "detune"
            ])), {
                type: "sine"
            ...
            modulation: Object.assign(omitFromObject(OmniOscillator.getDefaults(), __spread(Object.keys(Source.getDefaults()), [
                "frequency",
                "detune"
            ])), {
                type: "square"
