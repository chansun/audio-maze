...
declare type VoiceOptions<T> = T extends MembraneSynth ? MembraneSynthOptions : T extends MetalSynth ? MetalSynthOptions : T extends FMSynth ? FMSynthOptions : T extends AMSynth ? AMSynthOptions : T extends Synth ? SynthOptions : never;
/**
